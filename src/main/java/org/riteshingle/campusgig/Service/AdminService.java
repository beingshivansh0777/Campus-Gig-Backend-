...
public class AdminService {
    ...
    //    CHANGED: added password verification + adminAccessStatus enforcement
    public Map<String, String> login(AdminAuthDTO dto, HttpServletResponse response) {
        ...
        //   NEW: verify password — this was completely missing before
    ...
    //    CHANGED: RuntimeException -> BadRequestException for consistent error responses
