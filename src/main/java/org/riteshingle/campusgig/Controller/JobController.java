...
public class JobController {
    ...
    @PreAuthorize("hasRole('CLIENT')")
    @GetMapping("/my-jobs")
    public ResponseEntity<Page<JobResponseDTO>> getJobsPostByMe(@RequestParam(required = false,defaultValue = "OPEN") String status, @RequestParam(required = false, defaultValue = "1") int page,
                                                                @RequestParam(required = false, defaultValue = "10") int size,
                                                                @RequestParam(required = false, defaultValue = "ASC") String direction,
